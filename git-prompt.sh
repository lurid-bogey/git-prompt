...
__git_ps1_colorize_gitstring ()
{
	if [ -n "${ZSH_VERSION-}" ]; then
		...
		local c_yellow="${c_pre}33${c_post}"
		local c_blue="${c_pre}34${c_post}"
		local c_magenta="${c_pre}35${c_post}"
		local c_cyan="${c_pre}36${c_post}"
		local c_lred="${c_pre}1;31${c_post}"
		local c_lgreen="${c_pre}1;32${c_post}"
		local c_lyellow="${c_pre}1;33${c_post}"
		local c_lblue="${c_pre}1;34${c_post}"
		local c_lmagenta="${c_pre}1;35${c_post}"
		local c_lcyan="${c_pre}1;36${c_post}"
